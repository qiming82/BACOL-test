...
C
      ...
      del = 1.d0
      del2 = del*del
c      FVAL(1) = -3.0*U(1)*U(1)*UX(1)*(UX(1)+UX(2))
c     *          - U(1)**3*(UXX(2)+U(2))-Eb*U(2)
      FVAL(1) = -Ux(1)**2 - 0.5d0*U(1)*U(2) -
     *   2.d0*del2*U(1)**2*Ux(1)*Ux(2)-0.5*del2*U(1)**3*Uxx(2) 
...
C
      ...
      DFDU(1,1) = -0.5*U(2)-4.0*del2*U(1)*UX(1)*UX(2)
     +  -1.5*del2*U(1)*U(1)*UXX(2)
      DFDU(1,2) = -0.5*U(1)
      DFDU(2,1) = 0.0
      DFDU(2,2) = -1.0/eps
      DFDUX(1,1) = -2.0*UX(1) - 2.0*del2*U(1)**2*UX(2)
      DFDUX(1,2) = -2.0*del2*U(1)*U(1)*UX(1)
      DFDUX(2,1) = 0.0
      DFDUX(2,2) = 0.0
      DFDUXX(1,1) = 0.0
      DFDUXX(1,2) = -del2/2.0*U(1)**3
      DFDUXX(2,1) = 1.0/eps
      DFDUXX(2,2) = 0.0
